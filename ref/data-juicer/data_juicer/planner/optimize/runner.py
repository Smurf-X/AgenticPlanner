...
from data_juicer.planner.contracts.recipe import DJExecutableConfig, save_executable_config
...
from data_juicer.planner.optimize.optimization_config import OptimizationConfig
...
if TYPE_CHECKING:
    ...
    from data_juicer.planner.optimize.executor_adapter import ExecutorAdapter
...
class OptimizationRunner:
    ...
    def from_config(
        ...
        """
        from data_juicer.planner.optimize.evaluator import create_evaluator
