...
from data_juicer.planner.generate.embedding.backend import EmbeddingBackend, normalize_vectors
from data_juicer.tools.op_search import OPRecord

logger = logging.getLogger(__name__)


def _make_operator_document(rec: OPRecord) -> str:
...
class OperatorVectorIndex:
    ...
    def build(self, records: List[OPRecord], show_progress: bool = False) -> None:
        """
    ...
    def load(self, records: List[OPRecord], path: Optional[str] = None) -> bool:
        """
